...
public class ExprBroadcaster extends SimpleExpression<String> {

    static {
        Skript.registerExpression(ExprBroadcaster.class, String.class, ExpressionType.SIMPLE, "[event-]broadcaster");
    }
    ...
    protected String[] get(Event event) {
        if (event instanceof BridgeEventChat) {
            ...
            return new String[]{String.valueOf(chatter.getBroadcaster())};
        }
        else
            return new String[0];
    }
