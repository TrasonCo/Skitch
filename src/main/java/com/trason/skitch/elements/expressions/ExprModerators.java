...
public class ExprModerators extends SimpleExpression<String> {

    static {
        Skript.registerExpression(ExprModerators.class, String.class, ExpressionType.SIMPLE, "[event-]moderators");
    }
